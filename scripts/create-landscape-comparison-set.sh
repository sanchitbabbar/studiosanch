...
build_dir="/private/tmp/sanch-landscape-comparison"
...
render_comparison \
  ...
  72.083333 67000 67800 70600 "$build_dir/common-score-72.wav" \
  "$output_dir/comparison-03-continuous-camera-passage-landscape.mp4"

echo "Created:"
ls -lh "$output_dir"/comparison-*-landscape.mp4
