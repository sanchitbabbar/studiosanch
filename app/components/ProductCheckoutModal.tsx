                  ...
                  <p className="text-[9px] italic text-white/30 text-center mt-2">
                    {product.id === 'artbook-main'
                      ...
                      : product.id === 'sanch-suede'
                        ? fr
                          ? "En validant cette commande, vous reconnaissez que cet article est fabriqué sur mesure selon vos spécifications, et vous renoncez à votre droit de rétractation conformément à l'article L.221-28 du Code de la consommation."
                          : 'By placing this order, you acknowledge that this item is custom-manufactured to your specifications, and you waive your right of withdrawal pursuant to Article L.221-28 of the French Consumer Code.'
                      : fr
