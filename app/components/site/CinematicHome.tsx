...
const productionSlideshow = [
  ...
  { src: '/images/landing-production/frame-14-cinematographer-angle-screen-blurred.webp', alt: 'Studio Sanch couple filmed with the camera positioned on the right' },
